...
public class MainGUI extends javax.swing.JFrame implements Closeable {
    ...
    private DataGeneratorFrame1 dataGeneratorFrame = null;
    ...
    private void initComponents() {
        ...
        menuDataGenerator = new javax.swing.JMenuItem();
        ...
        menuDataGenerator.setText("Data generator");
        menuDataGenerator.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuDataGeneratorActionPerformed(evt);
            }
        });
        jMenu2.add(menuDataGenerator);
    ...
    private void menuDataGeneratorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuDataGeneratorActionPerformed
        showDataGeneratorWindow();
    }//GEN-LAST:event_menuDataGeneratorActionPerformed
    
    private void showDataGeneratorWindow() {
        if (dataGeneratorFrame == null) {
            try {
                //dataGeneratorFrame = new DataGeneratorFrame(w);
                dataGeneratorFrame = new DataGeneratorFrame1(w);
            } catch (Exception ex) {
                Logger.getLogger(MainGUI.class.getName()).log(Level.SEVERE, null, ex);
            }
            dataGeneratorFrame.setVisible(true);

            
            Util.CallableOnClosed callMe = new Util.CallableOnClosed() {
                @Override
                public void callMe() {
                    dataGeneratorFrame = null;
                }
            };    
            Util.callOnClosed(dataGeneratorFrame, callMe);
        } else {
            dataGeneratorFrame.toFront();
        }
    }
    ...
    private javax.swing.JMenuItem menuDataGenerator;
